    ...
    <div id="form">
        <form action="conuserdetails.php" method="post">
            <fieldset style="width:80%; margin: auto">
                ...
                <input type="radio" name="pref" value="straight"> Straight<br>
                <input type="radio" name="pref" value="gay">Homosexual<br>
                <input type="radio" name="pref" value="bi"> Bi-Sexual<br>
                ...
                <br>Enter Location:<br>
    <input type=text name="locate" required placeholder="location">
